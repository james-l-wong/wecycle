      ...
      <ScrollView>
        <View style={{ marginLeft: 20 }}>
          ...
          <Text style={styles.normal}>
            {" "}
            View information about the services available {"\n"} for your
            devices
          </Text>
        </View>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <StarRating rating="5" color="#FFFFFF" onChange={setRating} />
                </View>
                <ContactOptions />
              </View>
            </View>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <StarRating rating="3" color="#FFFFFF" onChange={setRating} />
                </View>
                <ContactOptions />
              </View>
            </View>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <StarRating rating="4" color="#FFFFFF" onChange={setRating} />
                </View>
                <ContactOptions />
              </View>
            </View>
            <ModalCustom
              name={"Calling the Service"}
              context={showCallModal}
              setter={setShowCallModal}
            />
            <ModalCustom
              name={"Opening Email Application on your device"}
              context={showEmailModal}
              setter={setshowEmailModall}
            />
            <ModalCustom
              name={"Opening Website of the service"}
              context={showWebsiteModal}
              setter={setShowWebsiteModal}
            />
            <ModalCustom
              name={"Service saved"}
              context={showSaveModal}
              setter={setshowSaveModal}
            />
          </View>
        )}
      </ScrollView>
